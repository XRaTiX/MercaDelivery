                        ...
                        <div class="col-lg-12">
                            <div class="slider__content">
                                <div class="contentbox">
                                    <h2>Temporada de <span>Mango </span></h2>
                                    <h2>A <span>solo </span></h2>
                                    <h2>$ <span>0.95 </span></h2>
                                    <a class="shopbtn" href="#">Comprar Ahora</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="product product__style--3">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product__thumb">
                                ...
                                <div class="hot__box">
                                    <span class="hot-label">Temporada</span>
                                </div>
                            </div>
                            <div class="product__content content--center">
                                <h4><a href="single-product.php">Mango</a></h4>
                                <ul class="prize d-flex">
                                    <li>$0.85</li>
                                    <li class="old_prize">$1.00</li>
                                </ul>
                            </div>
                        </div>
                    </div>
