                                    ...
                                    <li class="drop"><a href="#">Catalogo</a>
                                        <div class="megamenu mega03">
                                            <ul class="item item03">
                                                ...
                                                <li><a href="shop-grid.html">Verduras</a></li>
                                            </ul>
                                            ...
                                            <div class="single__items">
                                                <div class="miniproduct">
                                                    ...
                                                    <div class="item01 d-flex mt--20">
                                                        ...
                                                        <div class="content">
                                                            <h6><a href="product-details.html">Pera</a></h6>
                                                ...
                                                <div class="switcher-options">
                                                    <div class="switcher-currency-trigger">
                                                        <div class="setting__menu">
                                                            ...
                                                            <span><a href="#">Crearse una cuenta</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="row d-none">
                        <div class="col-lg-12 d-none">
                            <nav class="mobilemenu__nav">
                                ...
                                <li><a href="shop-grid.html">Catalogo</a>
                                    <ul>
                                        <li><a href="shop-grid.html">Frutas</a></li>
                                        <li><a href="shop-grid.html">Verduras</a></li>
                                    </ul>
